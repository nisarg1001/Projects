...
<div class="container">
 ...
 <form method="post" action="confirm.jsp">
    ...
    <div class="form-group">
      ...
      <input type="date" class="form-control" id='ed_starttimedate' placeholder="Enter Start Date" name="sdate" min=2022-04-28 required>
    </div>
     
         <div class="form-group">
      <label for="email">End Date:</label>
      <input type="date" class="form-control"  id='ed_endtimedate'placeholder="Enter End Date" name="edate" min=2022-04-28 required>
    </div>
